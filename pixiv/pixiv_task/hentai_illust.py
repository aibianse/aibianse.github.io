...
path = './pixiv/pixiv_data/hentai_illust/'
repeat = 1
count = 1
for n in range(1, 2):
    url = 'https://www.pixiv.net/ranking.php?mode=daily_r18&content=illust&p=%d&format=json' % n
    ...
    for url in picUrl:
        ...
        image_name = 'aibianse_com_' + str(count) + '.webp'
